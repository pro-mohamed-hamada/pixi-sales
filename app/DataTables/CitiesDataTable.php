...
class CitiesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('governorate', function(City $model){
                return $model->governorate->name;
            })
            ->filterColumn('governorate', function($query, $keyword) {
                $query->whereHas('governorate', function($query) use ($keyword) {
     ...
     */
    public function query(CityService $service): QueryBuilder
    {
