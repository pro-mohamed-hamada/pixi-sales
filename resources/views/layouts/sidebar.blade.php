...
<section class="sideBar col-xs-2  col-md-3 col-lg-2 text-left">
        <ul>
                ...
                <li><a class="sidebare-button list-group-item" href="{{route('clients.index')}}"><span class="fa fa-product-hunt"></span> <span>{{ __("lang.governorates") }}</span></a></li>
                <li><a class="sidebare-button list-group-item" href="{{route('clients.index')}}"><span class="fa fa-product-hunt"></span> <span>{{ __("lang.cities") }}</span></a></li>
                ...
                <li><a class="list-group-item" href="{{route('activity-logs.index')}}"></span> <span class="fa fa-users"></span> <span>{{ __("lang.services") }}</a></li>
                <li><a class="list-group-item" href="{{route('activity-logs.index')}}"></span> <span class="fa fa-users"></span> <span>{{ __("lang.status") }}</a></li>
        </ul>
</section>