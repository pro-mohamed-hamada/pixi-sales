                                ...
                                <div class="row mb-3 g-3">
                                    <div class="col-lg-4">
                                        ...
                                        <select id="countries" name="country_id" class="form-control">
                                            ...
                                            <option value="{{ $country->id }}" {{ $country->id == $client->city->governorate->country_id ? "selected":"" }}>{{ $country->name }}</option>
                                            @endforeach
                                        <select>
                                    </div>
                                    <div class="col-lg-4">
                                        ...
                                        <select id="governorates" name="governorate_id" class="form-control">
                                            @foreach ($client->city->governorate->country->governorates as $governorate)
                                            <option value="{{ $governorate->id }}" {{ $governorate->id == $client->city->governorate_id ? "selected":"" }}>{{ $governorate->name }}</option>
                                            @endforeach
                                        <select>
                                    </div>
                                    <div class="col-lg-4">
